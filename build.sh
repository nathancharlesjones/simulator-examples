...
# Compile hardware/x86/raygui_advanced.o
gcc 	-Wall -ffunction-sections -fdata-sections -g3 -O0 	-I application/advanced -I hardware -I ../raygui/src -I ../raylib/src 	-c hardware/x86/raygui_advanced.c 					-o build/hardware/x86/raygui_advanced.o
